      ...
      {step === 6 && (
        <View style={styles.cardBalance}>
          <View style={{ flexDirection: "row", gap: 10, alignItems:'center' }}>
            ...
            <Text style={{fontSize:20, fontWeight:'600'}}>Houve um erro no resgate</Text>
          </View>
      ...
      {step === 8 && (
        <View style={styles.cardWarning}>
          ...
          <Text style={{ paddingRight: 10 }}>
            Você só pode realizar transferências via PIX para sua conta pessoal.
            Não é permitido a transferência para terceiros pelo aplicativo do
            Clube Pro+.
          </Text>
        </View>
      )}
